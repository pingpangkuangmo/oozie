...
# Now lets fake hadoop-client, since hadoop-client in 20.X seems unreliable
install -d -m 0755 ${OOZIE_DATA}/hadoop-client
tar -C ${OOZIE_DATA}/hadoop-client --strip-components=3 -xzf ${OOZIE_BUILD_DIR}/oozie-hadooplibs*.tar.gz
